...
tags: ["espresso", "coffee", "history", "guide", "tamper", "types"]
---
...
the most famous faces is the flat base tamper and the Ripple tamper. There is also some tamper with curves. In fact the curved compress a bit mor the center part to offer different tamping and water dissipation.
